...
export default function FlexiblePlanEditor({ plan, onChange, requestedCount = 4, description = '', onApplySelected, referenceCount = 0, applying = false }: { plan: ImageSetPlan; onChange: (plan: ImageSetPlan) => void; requestedCount?: number; description?: string; onApplySelected?: () => void | Promise<void>; referenceCount?: number; applying?: boolean }) {
