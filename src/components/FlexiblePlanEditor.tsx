...
export default function FlexiblePlanEditor({ plan, onChange, requestedCount = 4, description = '', onApplySelected }: { plan: ImageSetPlan; onChange: (plan: ImageSetPlan) => void; requestedCount?: number; description?: string; onApplySelected?: () => void }) {
